...
public class DataStoreConsumer {
	public static void main(String[] args) {
		...
		jsonObject.put("firstName", "Abishek");
		jsonObject.put("lastName", "Srinivasan");
		jsonObject.put("address", "Karur");
		System.out.println("=============================================================");
		System.out.println("========================CREATE ==============================");
		System.out.println("=============================================================");
		// Create Operation
		// DataStore myDataStore = new DataStore();
		DataStore myDataStore = new DataStore("C:\\Users\\Admin\\Downloads\\freshworks\\DataStore-master\\DataStore");
